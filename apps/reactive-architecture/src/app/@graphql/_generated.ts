...
export type AllPaymentsOfIbanQueryVariables = Exact<{
  fromIban: Scalars['String'];
}>;

export type AllPaymentsOfIbanQuery = {
  readonly banking_payments: ReadonlyArray<{
    readonly id: number;
    readonly amount: any | null;
    readonly date: any | null;
    readonly from_iban: string | null;
    readonly from_name: string | null;
    readonly payment_reference: string | null;
    readonly to_iban: string | null;
...
export type CreatePaymentMutation = {
  readonly insert_banking_payments: { readonly returning: ReadonlyArray<{ readonly id: number }> } | null;
};

export type OnPaymentsSubscriptionSubscriptionVariables = Exact<{
  iban: Scalars['String'];
}>;

export type OnPaymentsSubscriptionSubscription = {
  readonly banking_payments: ReadonlyArray<{
    readonly amount: any | null;
    readonly date: any | null;
    readonly from_iban: string | null;
...
export type OnTransactionSubscriptionSubscriptionVariables = Exact<{
  iban: Scalars['String'];
}>;

export type OnTransactionSubscriptionSubscription = {
  readonly banking_transactions: ReadonlyArray<{
    readonly amount: any | null;
    readonly execution_date: any | null;
    readonly from_iban: string | null;
    readonly from_name: string | null;
    readonly id: number;
    readonly payment_reference: string | null;
...
export const AllPaymentsOfIbanDocument = gql`
...
export class AllPaymentsOfIbanGQL extends Apollo.Query<AllPaymentsOfIbanQuery, AllPaymentsOfIbanQueryVariables> {
  override document = AllPaymentsOfIbanDocument;
...
export class OnPaymentsSubscriptionGQL extends Apollo.Subscription<
  OnPaymentsSubscriptionSubscription,
  OnPaymentsSubscriptionSubscriptionVariables
> {
  override document = OnPaymentsSubscriptionDocument;
...
export const OnTransactionSubscriptionDocument = gql`
  subscription OnTransactionSubscription($iban: String!) {
    banking_transactions(
      where: { _or: [{ from_iban: { _eq: $iban } }, { to_iban: { _eq: $iban } }] }
      order_by: { id: desc }
    ) {
      amount
      execution_date
...
export class OnTransactionSubscriptionGQL extends Apollo.Subscription<
  OnTransactionSubscriptionSubscription,
  OnTransactionSubscriptionSubscriptionVariables
> {
  override document = OnTransactionSubscriptionDocument;
